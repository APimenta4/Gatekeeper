...
The project's evaluation report can be found in the [REPORT](report/REPORT.md) file. It contains information about the design of the tool, the achieved results (with FP/FN analysis tables) and lessons learnt during its development.
